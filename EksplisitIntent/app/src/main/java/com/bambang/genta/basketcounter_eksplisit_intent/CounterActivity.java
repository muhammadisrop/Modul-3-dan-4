...
import com.bambang.genta.SplashScreenActivity;
import com.bambang.genta.auth.SimpleLoginActivity;
import com.bambang.genta.auth.PrefManager;
...
public class CounterActivity extends AppCompatActivity {
    ...
    public void counter(View view) {
        if (view.getId() == R.id.btn_score_one_tim_a) {
            ...
            startActivity(new Intent(CounterActivity.this, SimpleLoginActivity.class));
